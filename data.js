...
const SCORERS = [
  { name: "Lionel Messi",        code: "ARG", goals: 6 },
  { name: "Vinícius Júnior",     code: "BRA", goals: 4 },
  { name: "Kylian Mbappé",       code: "FRA", goals: 4 },
  { name: "Ousmane Dembélé",     code: "FRA", goals: 4 },
  { name: "Erling Haaland",      code: "NOR", goals: 4 },
  { name: "Matheus Cunha",       code: "BRA", goals: 3 },
  { name: "Jonathan David",      code: "CAN", goals: 3 },
  { name: "Yoane Wissa",         code: "COD", goals: 3 },
  { name: "Kai Havertz",         code: "GER", goals: 3 },
  { name: "Deniz Undav",         code: "GER", goals: 3 },
  { name: "Brian Brobbey",       code: "NED", goals: 3 },
  { name: "Cody Gakpo",          code: "NED", goals: 3 },
  { name: "Elijah Just",         code: "NZL", goals: 3 },
  { name: "Ismaïla Sarr",        code: "SEN", goals: 3 },
  { name: "Johan Manzambi",      code: "SUI", goals: 3 },
  { name: "Ismael Saibari",      code: "MAR", goals: 3 },
  { name: "Harry Kane",          code: "ENG", goals: 3 },
  { name: "Riyad Mahrez",        code: "ALG", goals: 2 },
  { name: "Marko Arnautović",    code: "AUT", goals: 2 },
  { name: "Leandro Trossard",    code: "BEL", goals: 2 },
  { name: "Ermin Mahmić",        code: "BIH", goals: 2 },
  { name: "Cyle Larin",          code: "CAN", goals: 2 },
  { name: "Daniel Muñoz",        code: "COL", goals: 2 },
  { name: "Jude Bellingham",     code: "ENG", goals: 2 },
  { name: "Ramin Rezaeian",      code: "IRN", goals: 2 },
  { name: "Nicolas Pépé",        code: "CIV", goals: 2 },
  { name: "Daichi Kamada",       code: "JPN", goals: 2 },
  { name: "Ayase Ueda",          code: "JPN", goals: 2 },
  { name: "Julián Quiñones",     code: "MEX", goals: 2 },
  { name: "Crysencio Summerville", code: "NED", goals: 2 },
  { name: "Rubén Vargas",        code: "SUI", goals: 2 },
  { name: "Mikel Oyarzabal",     code: "ESP", goals: 2 },
  { name: "Yasin Ayari",         code: "SWE", goals: 2 },
  { name: "Anthony Elanga",      code: "SWE", goals: 2 },
  { name: "Maximiliano Araújo",  code: "URU", goals: 2 },
  { name: "Cristiano Ronaldo",   code: "POR", goals: 2 },
  { name: "Folarin Balogun",     code: "USA", goals: 2 },
  { name: "Pape Gueye",          code: "SEN", goals: 2 },
];
